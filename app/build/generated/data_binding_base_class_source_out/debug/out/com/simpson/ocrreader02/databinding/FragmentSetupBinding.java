...
public final class FragmentSetupBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout fragmentSecond;

  @NonNull
  public final TextView textviewSecond;

  private FragmentSetupBinding(@NonNull NestedScrollView rootView, @NonNull Button buttonSecond,
      @NonNull ConstraintLayout fragmentSecond, @NonNull TextView textviewSecond) {
  ...
  public static FragmentSetupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout fragmentSecond = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentSetupBinding((NestedScrollView) rootView, buttonSecond, fragmentSecond,
          textviewSecond);
    }
