...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  @NonNull
  public final NestedScrollView fragmentSecond;
  ...
  private FragmentSecondBinding(@NonNull NestedScrollView rootView, @NonNull Button buttonSecond,
      @NonNull NestedScrollView fragmentSecond, @NonNull TextView textviewSecond) {
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      NestedScrollView fragmentSecond = (NestedScrollView) rootView;
      ...
      return new FragmentSecondBinding((NestedScrollView) rootView, buttonSecond, fragmentSecond,
          textviewSecond);
    }
